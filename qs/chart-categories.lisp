(let* ((raw (read-canonical input-file))
  ...
  (write-html raw "raw.html" "Raw data" t)
  (write-csv monthly "monthly.csv")
  (write-html monthly "monthly.html" "Raw monthly summary" t)
  ...
  (write-html by-class "by-class.html" "Categorised monthly summary" t)
