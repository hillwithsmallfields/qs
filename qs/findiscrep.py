...
def main():
    ...
    # todo: deduce format of input file

    # todo: scan input file looking at all the comparison columns, and outputting the last value in each of them for each month, the results being two columns, the total discrepancy that month, and the difference since the previous month
